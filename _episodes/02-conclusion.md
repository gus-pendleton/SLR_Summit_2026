...
We have come to the end of this workshop! You learned some basic procedures for importing and visualizing your data.

If you enjoyed this lesson and want to learn more, you're in luck! This was the first lesson in a larger, two-day course Gus teaches. [You can access the entire course here](https://marschmilab.github.io/Cornell_Carpentries_Curriculum/) - not only will you review your ggplot lessons (with new data!), but you'll learn how to clean and organize your data with the tidyverse, run and interpret basic statistics, and compile your findings in an RMarkdown report!

As you continue on your coding journey with your own data, two things will happen:
